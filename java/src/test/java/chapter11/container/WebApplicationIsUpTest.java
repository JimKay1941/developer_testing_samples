 ...
 */
public class WebApplicationIsUpTest {
    ...
    public static void setUpOnce() throws Exception {
        ...
        final String pathToWarFile = "<war file location>";
        server.setHandler(new WebAppContext(pathToWarFile, "/webapp"));
        server.start();
    }

    @Ignore("This test fails, because there's no WAR file.")
    @Test
